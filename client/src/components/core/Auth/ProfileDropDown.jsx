    ...
    <div className="relative">
      {mobile ? (
        <div className="w-full">
          <button
            className="flex w-full items-center gap-3 p-2 rounded-lg hover:bg-richblack-700 transition-all duration-200 focus:outline-none"
          ...
          >
            <div className="relative">
              <img
                ...
                className="aspect-square w-10 h-10 rounded-full object-cover border-2 border-richblack-500"
                onError={(e) => {
            ...
            <div className="text-left flex-1">
              ...
              <p className="text-xs text-richblack-300">View Profile</p>
            </div>
            <AiOutlineCaretDown
      ...
      {open && (
        <div
          className={`${mobile ? 'relative w-full mt-2' : 'absolute top-full right-0 mt-2 w-56'} z-50 rounded-lg bg-richblack-800 border border-richblack-600 shadow-lg overflow-hidden`}
          ref={ref}
